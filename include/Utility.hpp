...
public:
    ...
    static std::unique_ptr<CxxSDNN::IzhikevichActivation> make_izhikevich(double input_scale, double output_scale, std::vector<size_t> shape, Izhi::NeuronType type)
    {
