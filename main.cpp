...
{   
    ...
    xt::xarray<double> tr_target = xt::view(tr_raw, xt::range(1, _));
    ...
    xt::xarray<double> vl_target = xt::view(vl_raw, xt::range(1, _));
    ...
    auto izh_act_1 = UtilityFunctionLibrary::make_izhikevich(70, 1/60., 2u, NeuronType::RegularSpiking);
    auto izh_act_2 = UtilityFunctionLibrary::make_izhikevich(70, 1/60., 2u, NeuronType::Resonator);
